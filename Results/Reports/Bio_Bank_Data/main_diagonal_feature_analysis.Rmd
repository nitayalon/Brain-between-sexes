...
men_density <- density(brain_feature$feature_residuals$value[brain_feature$feature_residuals$sex == 0], n = 80)
women_density <- density(brain_feature$feature_residuals$value[brain_feature$feature_residuals$sex == 1], n = 80)
plot(men_density$x, log(men_density$y / women_density$y))
```

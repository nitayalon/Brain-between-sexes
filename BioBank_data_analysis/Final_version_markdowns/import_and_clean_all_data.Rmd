...
```{r april 2020 update}
daphna_names <- read.delim("~/Human_brain_research/BioBank_data_analysis/columns_names.txt",header = F)
```
...
names(demographic_data) <- c("Sex","Year_Of_Birth",
                             ...
                             "Ethnic_BG_2",
                             "Ethnic_BG_3")
list.of.names <- daphna_names$V1
relevant_data <- bio_bank_data[,names(bio_bank_data) %in% list.of.names]
full_relevant_data <- cbind(demographic_data, relevant_data)rm()
```

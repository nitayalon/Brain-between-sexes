...
pure_type_features_log <- biobank_feature_standard_analysis[pure_type_features_for_correlation_analysis_names]
...
names(pure_type_men_feature_data_log) <- c("eid", pure_type_features_for_correlation_analysis_names)
...
names(pure_type_women_feature_data_log) <- c("eid", pure_type_features_for_correlation_analysis_names)
pure_type_women_feature_data_log_no_id_log <- pure_type_women_feature_data_log[,-1]
```

```{r correlation matrix by gender pure types, include=FALSE}
pure_type_men_cor_log <- cor(pure_type_men_feature_data_log_no_id_log , use = "pairwise.complete.obs")
pure_type_women_cor_log <- cor(pure_type_women_feature_data_log_no_id_log ,use = "pairwise.complete.obs")

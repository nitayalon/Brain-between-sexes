...
pure_type_correlation_plot_legend <- data.frame(feature_name = colnames(pure_type_combined_correaltion_residuals), 
                                                number = 1:ncol(pure_type_combined_correaltion_residuals))
...
corrplot(pure_type_combined_correaltion_residuals, order = "alphabet", method = 'circle',tl.cex = 1.5,tl.srt = 45)
```
...
men_data_residuals <- lapply(two_mixture_model_features_residuals, function(x){x$hypothesis_results$mixture_model$men_responsebilities})

women_data_residuals <- lapply(two_mixture_model_features_residuals, function(x){x$hypothesis_results$mixture_model$women_responsebilities})
```
...
names(men_feature_data_residuals) <- c("eid", non_equal_probability_mixture_names)
...
names(women_feature_data_residuals) <- c("eid", non_equal_probability_mixture_names)
...
volume_features_two_mixture_model <- grep('Volume',two_mixture_model_corrplot_legend$feature_name)
MD_features_two_mixture_model <- grep('MD',two_mixture_model_corrplot_legend$feature_name)
weighted_mean_MD_features_two_mixture_model <- grep('Weighted-mean MD',two_mixture_model_corrplot_legend$feature_name)

FA_features_two_mixture_model <- grep('FA',two_mixture_model_corrplot_legend$feature_name)
...
corrplot(combined_correaltion_residuals[volume_features_two_mixture_model,volume_features_two_mixture_model], order = "alphabet",

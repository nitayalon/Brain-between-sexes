...
sourceAllFiles <- function()
{
  possible_computers <- c("nitayServer","Nitay-R-Droplet")
...
In this section our goal is to find patterns in the distribution stracture of the FDR significane features.  
